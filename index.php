...
?>
<table border="1">
<tr><th></th><th>Vorher</th><th>Nachher</th></tr>
<tr><td>Nutzer</td><td><?php echo $old_users_count; ?></td><td><?php echo $new_users_count; ?></td></tr>
<tr><td>Passwörter</td><td><?php echo $old_passes_count; ?></td><td><?php echo $new_passes_count; ?></td></tr>
<tr><td>Kombinationen gesamt</td><td><?php echo $old_data; ?></td><td><?php echo $new_data; ?></td></tr>
</table>
...
foreach($new_users as $aa){
	if(trim($aa) != '' && !in_array(trim($aa),$old_users)) $ausgabearray[] = $aa."<br /> \n";
}
